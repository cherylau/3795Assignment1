...
if (isset($_GET['id'])) {
  ...
  echo "<form action='delete_bucket_process.php' method='post'>
            ...
            <a href='../../actions/admin/manage_categories.php' class='btn btn-primary'>Cancel</a>
        </form>";
} else {
  echo "<p>No bucket ID provided.</p>";
  echo "<a href='../../actions/admin/manage_categories.php' class='btn btn-primary'>Go Back</a>";
}
